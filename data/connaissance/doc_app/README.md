...
| `parcelles-et-plan.md` | les parcelles (renommage, suppression logique, `est_pepiniere`, abri et paillage déclarés — US-181, le **nombre de rangs** déclaré d'une planche — US-197), le plan d'occupation, la **phase du moment** d'une culture en place (`recalage_calendrier.phase_de_serie`, US-194), ce que l'interpréteur de commandes rend dictable sur les parcelles (`app/services/interpreteur_commandes.py`) |
