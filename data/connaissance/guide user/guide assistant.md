...
| `/parcelle modifier <nom> clé=valeur…` | Modifier `exposition`, `superficie`, `ordre`, `pepiniere`, `abri`, `paillage`, `rangs` (1 à 99, ou `rangs=aucun` pour revenir à « non renseigné ») |
