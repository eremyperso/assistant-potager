...
| `app/services/{calendrier_cultural,contexte_semis,recalage_calendrier}.py`, `evenements.contexte_semis`, `potagers.zone_climatique`, bloc `cultures_calendriers` du manifeste Wind River | [calendrier-cultural.md](calendrier-cultural.md) |
