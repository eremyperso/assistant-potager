...
- **Mise à jour du 15/09/2026 (US-176, amendement d'US-068) :** la légende du CA6 et les « valeurs standard » des CA8/CA9 ne décrivent plus l'écran livré. La frise lit le référentiel du potager et distingue **quatre** phases — semis en pépinière (bleu), semis en pleine terre (violet), plantation (vert), récolte (ambre) — avec une règle de priorité déclarée quand deux phases partagent un mois (US-176 / CA3, CA3bis). Le principe du CA9 est conservé tel quel : aucune valeur inventée, frise neutre sans donnée
